...
<div style="text-align: center; padding: 40px 0;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; text-align: left; max-width: 900px; margin: 0 auto; color: #666;">
        <div>
            <h3 style="border-bottom: 1px solid #eee; padding-bottom: 10px;">Our Latest Standards</h3>
            <p><strong>30.09.26</strong> Domain X - Standard X.X</p>
            <p><strong>10.09.26</strong> Domain X - Standard X.X</p>
        </div>
        <div>
            <h3 style="border-bottom: 1px solid #eee; padding-bottom: 10px;">Coming Soon</h3>
            <p><strong>18.10.26</strong> Domain X - Standard X.X</p>
            <p><strong>24.11.26</strong> Domain X - Standard X.X</p>
        </div>
    </div>
</div>
